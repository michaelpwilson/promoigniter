...
if ( ! function_exists('test_method'))
{
    ...
    function intro($header, $text, $content)
    {
	    echo '<section class="intro"><div class="intro-body"><div class="container"><div class="row">';
                    echo '<div class="col-md-8 col-md-offset-2">';
                        echo '<h1 class="intro-header">' . $header . '</h1>';
                        echo '<p class="intro-text">' . $text . '</p>';
                        echo '<div class="intro-content">' . $content . '</div>';
                    echo '</div>';
            echo '</div></div></div></section>';
    }
    function sections($sections, $loggedin)
    {
	foreach($sections as $section) {
	  echo '<section id="' . $section['content-name'] . '" class="' . $section['class'] . '"><div class="row">';
    if($loggedin){
      if($section['content-type'] == "beauty"){
      echo '<div class="btn-group" style="float:left;">';
      echo '<button type="button" class="btn btn-default" dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog"></i> <span class="caret"></span></button>';
      echo '<ul class="dropdown-menu" role="menu"><li><a href="#">Layout</a></li><li><a href="#">Another action</a></li><li><a href="#">Something else here</a></li><li class="divider"></li><li><a href="#">Separated link</a></li></ul>';
      echo '</div>';
     } else {
      echo '<div class="btn-group" style="float:left; margin-top:-100px">';
      echo '<button type="button" class="btn btn-default" dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-cog"></i> <span class="caret"></span></button>';
      echo '<ul class="dropdown-menu" role="menu"><li><a id="' . $section['content_id'] . '" class="layout" data-toggle="modal" data-target="#sectionLayOut">Layout</a></li><li><a href="#">Another action</a></li><li><a href="#">Something else here</a></li><li class="divider"></li><li><a href="#">Separated link</a></li></ul>';
      echo '</div>';
     }
    } else {
